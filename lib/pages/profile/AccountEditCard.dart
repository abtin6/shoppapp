            ...
            Column(
              ...
              children: <Widget>[
                Padding(
                  ...
                  child: Text('شماره کارت خود را وارد نمائید',style: TextStyle(fontSize: 22,fontWeight: FontWeight.w600,color: Colors.black),),
                ),
                Form(
                    key: _formKey,
                    child: Column(
                      children: <Widget>[
                        InputFieldArea(
                            ...
                            validator: (String value) {
                              ...
                              if(!isLength(val, 2)) {
                              return 'لطفا شماره کارت صحیح وارد کنید';
                            }}
                        ),
                      ],
                    )
